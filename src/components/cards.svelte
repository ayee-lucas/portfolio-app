...
>
  <div
    ...
    aria-hidden
    role="button"
    class="border transition-all border-gray-600 w-52 h-28 grid place-items-center rounded-md text-sm group/cardproject relative card"
  >
  ...
  <div
    ...
    aria-hidden
    role="button"
    class="border transition-all border-gray-600 w-52 h-28 grid place-items-center rounded-md text-sm group/cardabout relative card"
  >
    <div class="grid place-items-center gap-3">
